...
const OtpLoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative">
      ...
      >
        <div className="glass-card rounded-[2.5rem] p-10 md:p-12 relative overflow-hidden premium-glow glow-blue">
          ...
          <div className="text-center mb-10">
            ...
            >
              ...
              <p className="text-white/40 text-xs font-black tracking-widest uppercase">
                {step === 1
                  ? "Initialize secure session tunnel."
            ...
            {step === 1 ? (
              ...
              >
                <div className="space-y-3">
                  <Label htmlFor="email" className="text-white/30 text-[10px] font-black uppercase tracking-[0.3em] ml-2">Secure Identifier</Label>
                  <div className="relative group">
                    <Mail className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-white/10 group-focus-within:text-blue-500 transition-colors" />
                    <input
                      id="email"
                      type="email"
                      value={email}
                      ...
                      required
                      className="w-full pl-14 pr-6 py-5 glass-morphism !bg-white/[0.02] rounded-2xl text-white font-bold placeholder-white/5 focus:outline-none focus:!bg-white/[0.05] focus:border-blue-500/30 transition-all border-transparent"
                ...
                <Button
                  type="submit"
                  disabled={otpLoading}
                  className="w-full bg-blue-600 hover:bg-blue-500 text-white py-8 rounded-[1.5rem] font-black text-xs tracking-[0.2em] shadow-2xl shadow-blue-600/20 transition-all transform active:scale-[0.98] group"
                >
                  {otpLoading ? (
              ...
              >
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    <KeyRound className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-white/10 group-focus-within:text-blue-500 transition-colors" />
                    <input
                      id="otp"
                      type="text"
                      value={otp}
                ...
                <Button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-500 text-white py-8 rounded-[1.5rem] font-black text-xs tracking-[0.2em] shadow-2xl shadow-blue-600/20 transition-all transform active:scale-[0.98]"
                >
                  {authLoading ? (
                    <RefreshCw className="w-6 h-6 animate-spin" />
                  ) : (
          ...
          <div className="mt-12 text-center pt-8 border-t border-white/5">
            <p className="text-white/20 text-[10px] font-black uppercase tracking-widest">
              No Profile Found?{' '}
              <Link to="/otp-signup" className="text-white hover:text-blue-400 transition-all ml-2 underline underline-offset-8 decoration-white/10 hover:decoration-blue-400">
                Register Identity
              </Link>
            </p>
          </div>
